...
public class Quiz extends AppCompatActivity implements View.OnClickListener {
    ...
    int score=0;
    int totalQuestion = Answers.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.titolo3));
        actionBar.setIcon(R.drawable.quiz_24);
        ...
        void loadNewQuestion(){
            ...
            questionTextView.setText(Answers.question[currentQuestionIndex]);
