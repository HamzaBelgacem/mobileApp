...
public final class SingleproductBinding implements ViewBinding {
  ...
  private SingleproductBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView productImg) {
  ...
  public static SingleproductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.singleproduct, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static SingleproductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SingleproductBinding((ConstraintLayout) rootView, productImg);
    }
